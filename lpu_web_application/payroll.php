...
<body style="background:black url(images/desimg/wave.jpg);">
    <div class="d-flex">
        ...
        <div class="flex-grow-1">
            <div class="container border bg-white">
                <h1 class="d-flex justify-content-center m-2" style="font-size:30px;">JEFF'S Choice Payroll</h1>
                <form class="row" method="post">
                    <div class="col">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            <h1 class="fs-5 mx-4">Employee Basic Info:</h1>
                            <div class="card mb-3 mx-4" style="width: 14rem;">
                                <img src="images/desimg/null.jpg" class="card-img-top" alt="..." height="190">
